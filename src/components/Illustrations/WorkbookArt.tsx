...
export const WorkbookArt: React.FC<ArtProps> = ({ name, size = 60, className = '', outlineOnly = false }) => {
  ...
  // Clean, professional educational workbook line-art illustrations (coloring-book ready, no emoji stickers)
  switch (key) {
    case 'cat':
    case 'g1_cvc_rhymes':
      return (
        <svg width={size} height={size} viewBox="0 0 100 100" fill="none" stroke="#1E293B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className={className}>
          ...
          {/* Inner ears */}
          <path d="M34 24 L42 34" />
          <path d="M66 24 L58 34" />
          {/* Eyes */}
    ...
    case 'clock':
    case 'g2_telling_time_routines':
      return (
        <svg width={size} height={size} viewBox="0 0 100 100" fill="none" stroke="#1E293B" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
          <circle cx="50" cy="50" r="38" fill={outlineOnly ? '#FFF' : '#FEF3C7'} />
          {/* Hour ticks */}
          <line x1="50" y1="20" x2="50" y2="24" strokeWidth="4" />
          <line x1="50" y1="80" x2="50" y2="76" strokeWidth="4" />
          <line x1="20" y1="50" x2="24" y2="50" strokeWidth="4" />
          <line x1="80" y1="50" x2="76" y2="50" strokeWidth="4" />
          {/* Hands showing 3:00 */}
          <line x1="50" y1="50" x2="50" y2="28" stroke="#1E293B" strokeWidth="4" />
          <line x1="50" y1="50" x2="68" y2="50" stroke="#EF4444" strokeWidth="3" />
    ...
    case 'g3_present_simple_continuous':
    case 'g3_reading_detective_treehouse':
      return (
        <svg width={size} height={size} viewBox="0 0 100 100" fill="none" stroke="#1E293B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className={className}>
          ...
          <line x1="37" y1="66" x2="43" y2="66" stroke="#78350F" strokeWidth="2" />
          <line x1="36" y1="74" x2="42" y2="74" stroke="#78350F" strokeWidth="2" />
          <line x1="36" y1="82" x2="42" y2="82" stroke="#78350F" strokeWidth="2" />
        </svg>
      );
    ...
    case 'g4_wh_questions_mystery':
      return (
        <svg width={size} height={size} viewBox="0 0 100 100" fill="none" stroke="#1E293B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className={className}>
          ...
          <line x1="34" y1="48" x2="35" y2="80" stroke="#B45309" strokeWidth="2" strokeDasharray="3 3" />
          <line x1="66" y1="48" x2="65" y2="80" stroke="#B45309" strokeWidth="2" strokeDasharray="3 3" />
        </svg>
      );
    ...
    default:
      return (
        <svg width={size} height={size} viewBox="0 0 100 100" fill="none" stroke="#1E293B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className={className}>
          ...
          <circle cx="60" cy="66" r="6" fill={outlineOnly ? '#FFF' : '#FEF08A'} stroke="#B45309" strokeWidth="2" />
        </svg>
      );
  }
};
